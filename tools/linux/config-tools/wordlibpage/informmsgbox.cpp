    ...
    if(is_abbre)
    {
        if(inputContent.contains("\n")){
            ...
            if(part_str_list.size() == 2){
                ...
                QString eliedStr_part1 = TOOLS::Utils::GetElidedText(font,part_str_list.at(0),350);
                QString eliedStr_part2 = TOOLS::Utils::GetElidedText(font,part_str_list.at(1),350);
                QString total_str = eliedStr_part1 + "\n" + eliedStr_part2;
                ui->content_label->setText(total_str);
            }
            else
            {
                QString eliedStr = TOOLS::Utils::GetElidedText(font,inputContent,400);
