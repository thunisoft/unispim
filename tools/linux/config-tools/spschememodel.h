...
private:
   ...
   */
    void ParserINIFile(QString fileName, QString groupname, QMap<QString,QString>& result);
   ...
   * @param[out]  文本
   */
    QString ConvertSPToString(QMap<QString, QString>& sp);
    QString GetUnUseSyllables(QMap<QString, QString>& sp, SYLLABLE_TYPE type);
public:
